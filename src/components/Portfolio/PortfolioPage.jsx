  ...
  return (
    ...
    >
      <div class="mx-auto flex flex-col justify-center px-4 sm:px-9  sm:max-w-2xl .5xl:w-[800px] lg:px-12 lg:max-w-7xl">
        <div>
          <h2 class=" text-base text-default font-mont font-semibold tracking-wide uppercase .5xl:text-lg ">
            Our Portfolio
          </h2>
          <p class="mt-2 max-w-3xl text-3xl font-mont font-[425] tracking-tight text-gray-900 .5xl:text-4xl">
            Check out some of our websites
          </p>
          <p class=" mt-5 mb-8 text-xl text-gray-500 md:mr-10  .5xl:text-1.5xl lg:w-[700px]">
            Here are a few examples of our best work so you can see firsthand
            the quality and style of NoCo Web Designs.
          </p>
        </div>
        <div>
